...
Today I publish some old screenshots of my first "true" raymarcher I coded last year. This first blog post only contains screendshots and texts, I forgot where the source code is (lost on one of my HDDs).
...
I added a distance-based fog using a color palette, trying to mimic the goal image. And it resulted in :
...
To obtain this shape :
1. start with a "Inner" pyramid.
2. add the external structures by subtracting a box from a larger pyramid. 
